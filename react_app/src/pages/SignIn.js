        ...
        if (passwordRegex.test(value)) {
          ...
          if (value.length > 0) {
            setFormErrors({
              ...formErrors,
              resetPassword:
                "password must contain minimum 6 and maximum 10 characters, at least one uppercase letter, one lowercase letter, one number and one special character",
            });
          } else {
            setFormErrors({ ...formErrors, resetPassword: "" });
          }
  ...
  return (
    <div>
        ...
        >
          ...
          >
            <Tab
              eventKey="email"
              title={
                <span style={{ color: tabKey === "email" ? "#007BFF" : "" }}>
                  <FaEnvelopeOpen
                    style={{
                      marginBottom: "5px",
                      marginRight: "15px",
                      ...
                      >
                        <Col sm={12} xs={12} md={12} style={{ padding: "0px" }}>
                          {formErrors.resetEmail.length > 0 && (
                            <span className="float-left error_msg">
                              {formErrors.resetEmail}
                            </span>
                          )}
                          {isValidResetEmail && tabKey == "email" ? (
                            <span className="validate_email_message">
            ...
            <Tab
              ...
              eventKey="password"
              title={
                <span style={{ color: tabKey == "password" ? "#228B22" : "" }}>
                  <FaUserShield
                    style={{
                      marginBottom: "5px",
                      marginRight: "15px",
          ...
          <Row style={{ padding: "0px", margin: "0px" }}>
            <Col
              ...
              xs={{
                span:
                  tabKey === "password" ||
                  (tabKey === "email" && !isValidResetEmail)
                    ? 8
                    : 4,
              }}
              sm={{
            ...
            >
              ...
              {isValidResetEmail && tabKey === "email" ? (
                ...
                <Button
                  ...
                  type="submit"
                >
                  {tabKey === "email" ? "Validate Email" : "Reset Password"}
                </Button>
              )}
            </Col>
      ...
      <Row className="shadow-lg"
        style={{ border: '1px solid lightgray', padding: "0px", margin: "0px" }}
      >
          ...
          <Form onSubmit={(e) => handleSubmit(e, "login", "")}>
            ...
            <Form.Group>
              <Row
                ...
                style={{ padding: '0px', margin: '0px', backgroundColor: '#F7F7F7', fontSize: "1.2rem", padding:'5px 0px', borderBottom: '1px solid lightgray' }}
              >
                <Col style={{ padding: '2px 10px', margin: '0px' }} xs={12} sm={12} md={12} lg={12} xl={12}>
                  <div style={{ fontSize: '1rem' }} className="float-left">Sign In</div>
                </Col>
              </Row>
            </Form.Group>
            <Form.Group style={{ padding: '0px 10px'  }} controlId="email">
            ...
            <Form.Group style={{ padding: '0px 10px'  }} controlId="password">
              ...
              <InputGroup>
                ...
                <InputGroup.Append>
                  <InputGroup.Text
                    ...
                    onClick={() =>
                      passwordVisibilityToggle("password", false, "")
                    }
                  >
                    {showPassword ? (
                      <FaEye style={{ color: "#007BFF" }} />
            ...
            <Row style={{ margin: "0px", padding: "0px" }}>
              ...
              >
                <p
                  ...
                  className="cursor_pointer forgot_password text-right"
                >
                  Forgot password ?
                </p>
              </Col>
            </Row>
            <Row style={{ margin: '0px',  padding: "0px 15px 15px 15px"  }}>
